        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 border-bottom border-sage-muted/20 pb-2">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('storage-management.show', $storage) }}" class="btn btn-outline-info">
                    ...
                    <div class="card">
                        <div class="card-header bg-light">
                            <h5 class="card-title mb-0">
                                <i class="ri-edit-line me-2"></i>Edit Storage Information
                            </h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('storage-management.update', $storage) }}" method="POST" id="storageForm">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row g-3 mb-4">
                                        ...
                                        <select name="storage_time_id" class="form-select @error('storage_time_id') is-invalid @enderror" required>
                                            ...
                                            @foreach($storageTime as $time)
                                                <option value="{{ $time->id }}"
                                                    {{ old('storage_time_id', $storage->storage_time_id) == $time->id ? 'selected' : '' }}>
                                                    {{ $time->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class=" col-md-3 mb-3">
                                        <label class="form-label">Storage Image</label>
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('capacity') is-invalid @enderror"
                                               id="capacity" name="capacity" value="{{ old('capacity', $storage->capacity) }}"
                                               placeholder="0.00">
                                        @error('capacity')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('temperature') is-invalid @enderror"
                                               id="temperature" name="temperature" value="{{ old('temperature', $storage->temperature) }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('humidity') is-invalid @enderror"
                                               id="humidity" name="humidity" value="{{ old('humidity', $storage->humidity) }}"
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror"
                                                  ...
                                                  placeholder="Additional notes about this storage location...">{{ old('description', $storage->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="d-flex justify-content-end gap-2">
                                            <a href="{{ route('storage-management.show', $storage) }}" class="btn btn-outline-secondary">Cancel</a>
                                            <button type="submit" class="btn btn-primary">
                                                <i class="ri-save-line me-1"></i>Update Storage
                                            </button>
                                        </div>
                                    </div>
                                </div>
