                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-sm btn-outline-warning  editBtn"
                                            data-id="{{ $soil->id }}" data-name="{{ $soil->name }}"
                                            data-code="{{ $soil->code }}" data-description="{{ $soil->description }}"
                                            data-status="{{ $soil->status }}">
                                            <i class="ri-edit-line"></i>
                                        </button>


                                        <form action="{{ route('soil-types.destroy', $soil->id) }}" method="POST"
                ...
                <form method="POST" id="soilForm" action="{{ route('soil-types.store') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="soilName"
                                class="form-control @error('name') is-invalid @enderror"
                                placeholder="Enter soil type name (example: Loamy Soil)" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="code" id="soilCode" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="soilStatus" class="form-select">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="soilDescription" class="form-control" rows="3"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('addSoilTypeBtn').addEventListener('click', function() {
                form.reset();
                document.getElementById('soilStatus').value = '1'; // default Active
            ...
            document.querySelectorAll('.editBtn').forEach(btn => {
                ...
                btn.addEventListener('click', function() {
                    ...
                    document.getElementById('soilStatus').value = this.dataset.status ?? '';
