...
if (href && n !== "/" + href && !a.getAttribute("data-bs-toggle")) {
    ...
    let layout = document.documentElement.getAttribute("data-layout");

    if (layout === "vertical" || layout === "semibox") {

        let twoColumnMenu = document.getElementById("two-column-menu");
        if (twoColumnMenu) {
